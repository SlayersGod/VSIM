...
struct RigidBodyComponent : ComponentBase
{
    ...
    //gsl::Vec3 inertiaTensor;
    //gsl::Vec3 inertiaTensorRotation;
    //RigidbodyInterpolation interpolation;
    bool isKinematic{true};
    GLfloat mass{1.f};
    GLfloat maxAngularVelocity;
    //Vec3 maxDepenetrationVelocity;
    gsl::Vec3 position;
    gsl::Quaternion rotation;
    //GLfloat sleepThreshold
    //GLint solverIterations
    ...
    //gsl::Vec3 getPointVelocity();
    //gsl::Vec3 getRelativePointVelocity();
    //bool isSleeping();
